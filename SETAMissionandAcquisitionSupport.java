...
public class SETAMissionandAcquisitionSupport extends aa_ActivityBase {

    @Override
    //onCreate method
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_setamissionandaquisitionsupport);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SETAMissionandAcquisitionSupport.this, ActivityMenu.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.supportMenu).setChecked(true);
        return true;
    }
