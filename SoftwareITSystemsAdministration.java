...
public class SoftwareITSystemsAdministration extends aa_ActivityBase {

    @Override
    //onCreate method
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_softwareitsystemsadministration);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SoftwareITSystemsAdministration.this, ActivityMenu.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.administrationMenu).setChecked(true);
        return true;
    }
