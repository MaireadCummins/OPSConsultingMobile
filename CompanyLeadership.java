...
public class CompanyLeadership extends aa_ActivityBase {

    @Override
    //onCreate method
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_companyleadership);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CompanyLeadership.this, ActivityMenu.class);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.leadershipMenu).setChecked(true);
        return true;
    }
